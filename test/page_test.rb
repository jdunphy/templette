...
class PageTest < Test::Unit::TestCase
  ...
  def test_generate_page_with_helper_method
    ...
    DynamicHelper.init(expected_content)
    FileUtils.mkdir('out') unless File.exists?('out')
    output_file = 'out/dynamic_template.html'
    assert !DynamicHelper.was_method_called?
    begin
  ...
  def test_generate_page_with_application_helper_method
    expected_content = 'generated by helper method'
    ApplicationHelper.init(expected_content)
    FileUtils.mkdir('out') unless File.exists?('out')
    output_file = 'out/application_template.html'
    assert !ApplicationHelper.was_method_called?
    begin
